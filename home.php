...
?>
    ...
    <section class="block-front-gradient">
        ...
        <div class="block-front-gradient-left">
            <h1>Международный поставщик товаров повседневного потребления</h1>
    ...
    <section class="our-advantages">
        ...
        <div class="our-advantages__block__right">
            <div class="our-advantages__block__right__top">
                ...
                <p><b>Собственные складские помещения</b> наличие погрузочно-разгрузочной техники и опытные грузчики обеспечивают трепетную сборку и оперативную отправку заказов любых объемов.</p>
            </div>
            <div class="our-advantages__block__right__bottom">
                <img class="our-adv-icon" src="<?php bloginfo('template_url'); ?>/assets/icon/arrow-t.svg" alt="">
                <p><b>Компетентность по вопросам доставки</b> обеспечивает наличие собственного автопарка у нашей компании. </p>
            </div>
