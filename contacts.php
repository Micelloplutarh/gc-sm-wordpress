        ...
        <div class="page-contacts">
            <div class="page-contacts-wrapper">
                    ...
                    <div class="page-contacts__info">
                        <h2>Контакты</h2>
                        <span class="page-contacts__info__list-item"><img class="icon" src="<?php bloginfo('template_url'); ?>/assets/icon/phone.svg" alt=""> 8 (977) 971-39-99<br>
                            8 (800) 201-39-99<br>
                        ...
                        <span class="page-contacts__info__list-item__geo"><img class="icon" src="<?php bloginfo('template_url'); ?>/assets/icon/pin.svg" alt=""> г. Москва, БЦ «Victory park plaza»i</span>
