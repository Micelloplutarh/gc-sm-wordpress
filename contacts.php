...
?>
    ...
    <section class="main-contacts">
        <h1>Контакты</h1>
        <p>Работаем Ежедневно с 08:00 до 18:00 (Мск) (сб., вс. — выходной)</p>
    </section>
    <section class="maps">
        ...
        <div class="page-contacts">
            <div class="page-contacts-wrapper">
                    ...
                    <div class="page-contacts__info">
                        <h2>Контакты</h2>
                        <span class="page-contacts__info__list-item aifs"><img class="icon" src="<?php bloginfo('template_url'); ?>/assets/icon/phone.svg" alt=""> 8 (977) 971-39-99<br> 
                            8 (800) 201-39-99<br> 
                            8 (495) 971-39-99</span>
                        ...
                        <span class="page-contacts__info__list-item__geo"><img class="icon" src="<?php bloginfo('template_url'); ?>/assets/icon/pin.svg" alt=""> г. Москва, ул. Рябиновая</span>
                        <span class="page-contacts__info__list-item__geo"><img class="icon" src="<?php bloginfo('template_url'); ?>/assets/icon/pin.svg" alt=""> г. Москва, БЦ «Victory park plaza»</span>
                        <span class="page-contacts__info__list-item__geo"><img class="icon" src="<?php bloginfo('template_url'); ?>/assets/icon/time.svg" alt=""> Ежедневно с 08:00 до 18:00<br> (Мск) (сб., вс. — выходной)</span>
                    </div>
                </div>
            </div>
